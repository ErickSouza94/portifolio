const Capabilites = () => {
  return (
    <div className="flex flex-col items-center justify-around md:gap-5 lg:flex-row lg:gap-10 border-b border-gray-400 pb-[20px]">
      <div className="flex items-center justify-center gap-10 px-10 text-3xl ">
      ...
      <div className="px-10 py-10 ">
        <h2 className="text-[32px] font-semibold pb-5 pt-20">
          Habilidades Técnicas
        </h2>
        <ul className="list-disc text-[20px] pb-20 w-[740px] max-w-[500px] text-2xl pl-[25px] ">
          <li className="pb-3">
