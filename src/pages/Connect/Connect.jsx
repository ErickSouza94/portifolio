...
const Connect = () => {
  return (
    <div className="flex flex-col items-center justify-around md:gap-5 lg:flex-row lg:gap-10 border-b border-gray-400 pb-[100px] w-[100%]">
      ...
      <div className="w-[100%] max-w-[400px] pt-20"><Forms
