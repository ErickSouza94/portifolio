...
const Projects = () => {
  ...
  return (
    <section className="flex flex-col justify-between w-auto gap-6 border-b-3 border-gray-500 pb-6">
      <h1 className="font-semibold">Projetos Realizados</h1>
      <Cards />
      <div className="botao flex justify-center py-10">
        <button
          onClick={toggleAllProjects}
          className="w-full py-4 text-center font-semibold text-xl border-2 border-gray-400 rounded-full cursor-pointer hover:scale-105 transition duration-300 hover:bg-[#D3E97A] hover:text-black"
        >
